...
def main():
    ...
    parser.add_argument(
        'wav_dir', metavar='wav-dir', type=Path,
        help='path to source WAV directory')
    parser.add_argument(
    ...
    recordings = Recording.load_recordings(args.wav_dir)
